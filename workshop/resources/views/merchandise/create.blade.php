                    ...
                    <div class="row shadow bg-light border">
                        ...
                        <div class="col-lg-8 p-5">
                                ...
                                <div class="col-12 form-group">
                                    <div class="row">
                                        <div class="col-sm-2 col-form-label">
                                            <label for="product-form-name">名稱 <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-10">
                                ...
                                <div class="col-12 form-group">
                                    <div class="row">
                                        <div class="col-sm-2 col-form-label">
                                            <label for="product-form-price">價格 <span class="text-danger" >*</span></label>
                                        </div>
                                        <div class="col-sm-10">
                                ...
                                <div class="col-12 form-group">
                                    <div class="row">
                                        <div class="col-sm-2 col-form-label">
                                            <label for="product-form-amount">數量 <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-10">
                                ...
                                <div class="col-12 form-group">
                                    <div class="row">
                                        <div class="col-sm-2 col-form-label">
                                            <label for="product-form-type">類型 <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-5">
                                            <div class="input-group">
                                                <select class="form-select required" name="type"  id="product-form-type">
                                                    <option value="">選擇商品類型</option>
                                                    <option value="A商品">超人氣排行榜</option>
                                                    <option value="B商品">2024中秋禮盒</option>
                                                    <option value="C商品">涼到夏到 | 夏季新品兩件9折</option>
                                                    <option value="D商品">熱銷優惠</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 form-group">
                                    <div class="row">
                                        <div class="col-sm-2 col-form-label">
                                            <label for="product-form-illustrate">說明 <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-5">
                                            <div class="input-group">
